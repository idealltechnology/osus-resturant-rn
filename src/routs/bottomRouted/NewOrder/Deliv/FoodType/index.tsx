...
var ff1: IFood = { code: '', price: 2, id: 1, name: 'pizza', image: '' };
var ff2: IFood = { code: '', price: 2, id: 2, name: 'salad', image: '' };
var ff3: IFood = { code: '', price: 2, id: 3, name: 'coca', image: '' };
var ff4: IFood = { code: '', price: 2, id: 4, name: 'soda', image: '' };
var ff5: IFood = { code: '', price: 2, id: 5, name: 'ghorme sabzi', image: '' };
var ff6: IFood = { code: '', price: 2, id: 6, name: 'joice', image: '' };
var ff7: IFood = { code: '', price: 2, id: 7, name: 'fish', image: '' };
var ff8: IFood = { code: '', price: 2, id: 8, name: 'sea plate', image: '' };
export default ({ select }: { select: (item: IFoodCategory) => void }) => {
  ...
  const [selectedFood, set_selectedFood] = useState<IFoodCategory>(ff1);
  ...
  return (
    <View>
      ...
      <FlatList
        showsHorizontalScrollIndicator={false}
        horizontal
        data={[ff1, ff2, ff3, ff4, ff5, ff6, ff7, ff8]}
        renderItem={foodItem}
        keyExtractor={(item, index) => index.toString()}
      />
    </View>
