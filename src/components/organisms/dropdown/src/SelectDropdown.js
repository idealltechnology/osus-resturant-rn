...
import { View, TouchableOpacity, FlatList, Dimensions, ActivityIndicator, Modal, I18nManager } from 'react-native';
      ...
      <TouchableOpacity
        ...
        {renderCustomizedRowChild ? (
          ...
          <CText
            ...
            text={rowTextForSelection ? rowTextForSelection(item, index) : item.toString()}
          />
        )}
      </TouchableOpacity>
    ) : (
          ...
          <View
            ...
            {!data || data.length == 0 ? (
              ...
              <FlatList
                ...
                ItemSeparatorComponent={() => (<CSeprator />)}
  ...
  return (
    <TouchableOpacity
      ...
      {renderCustomizedButtonChild ? (
        ...
        <CText numberOfLines={1} allowFontScaling={false} style={[styles.dropdownButtonText, buttonTextStyle]}
          text={isExist(selectedItem)
...
export default forwardRef((props: any, ref) => SelectDropdown(props, ref));
